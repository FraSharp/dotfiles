...
STCFLAGS = -O3 -Werror -Wshadow -Wall -Wextra -Wpedantic -pedantic -ffast-math -mfancy-math-387 -fno-ident -fmerge-all-constants -fno-unroll-loops -fno-math-errno -fno-unwind-tables -fno-asynchronous-unwind-tables -ffunction-sections -fdata-sections $(INCS) $(STCPPFLAGS)
STLDFLAGS = -Wl,--build-id=none -Wl,--hash-style=gnu,-O3 -s $(LIBS)
